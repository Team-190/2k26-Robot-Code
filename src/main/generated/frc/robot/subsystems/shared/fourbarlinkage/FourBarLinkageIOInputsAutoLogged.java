...
public class FourBarLinkageIOInputsAutoLogged extends FourBarLinkageIO.FourBarLinkageIOInputs
  ...
  public void toLog(LogTable table) {
    ...
    table.put("CanCoderAbsolutePosition", canCoderAbsolutePosition);
  }
  ...
  public void fromLog(LogTable table) {
    ...
    canCoderAbsolutePosition = table.get("CanCoderAbsolutePosition", canCoderAbsolutePosition);
  }

  public FourBarLinkageIOInputsAutoLogged clone() {
    FourBarLinkageIOInputsAutoLogged copy = new FourBarLinkageIOInputsAutoLogged();
    ...
    copy.canCoderAbsolutePosition = this.canCoderAbsolutePosition;
    return copy;
  }
}
