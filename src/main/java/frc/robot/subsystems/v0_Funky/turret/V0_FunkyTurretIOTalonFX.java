...
public class V0_FunkyTurretIOTalonFX {
  ...
  public V0_FunkyTurretIOTalonFX() {
    ...
    config.MotionMagic.MotionMagicAcceleration = V0_FunkyTurretConstants.CONSTRAINTS
        .MAX_ACCELERATION_RADIANS_PER_SECOND_SQUARED().get()
        * V0_FunkyTurretConstants.GEAR_RATIO;
    config.MotionMagic.MotionMagicCruiseVelocity = V0_FunkyTurretConstants.CONSTRAINTS
  ...
  public static double getEncoder1Value() {
    return rightCANcoder.getPosition().getValue().in(Units.Radians) - V0_FunkyTurretConstants.E1_OFFSET_RADIANS;
  }
  ...
  public static double getEncoder2Value() {
    return leftCanCoder.getPosition().getValue().in(Units.Radians) - V0_FunkyTurretConstants.E2_OFFSET_RADIANS;
  }
  ...
  /**
   * Method that sets goal position of turret and applies voltage to go to that
   * poisition
   * 
   * @param goalRadians
   */
  ...
  public void updateInputs(V0_FunkyTurretIOInputsAutoLogged inputs) {
    ...
    inputs.turretVelocityRadiansPerSecond = talonFX.getVelocity().getValue().in(Units.RadiansPerSecond)
        / V0_FunkyTurretConstants.GEAR_RATIO;
  ...
  public boolean atTurretPositionGoal() {
    ...
    return (Math.abs(positionGoalRadians - positionRadians) <= V0_FunkyTurretConstants.CONSTRAINTS
        .GOAL_TOLERANCE_RADIANS().get());
  }
  ...
  public void goToFieldRelativeAngle(double angleRadians) {
    double turretAngle = V0_FunkyRobotState.getHeading().getRadians() + angleRadians
