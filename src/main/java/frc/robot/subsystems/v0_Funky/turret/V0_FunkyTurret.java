...
public class V0_FunkyTurret {
    ...
    private Rotation2d calculateTurretAngle(Angle e1, Angle e2) {
        ...
        // Expected = Coarse * n1
        double expectedEnc1Total = coarseAngle * V0_FunkyTurretConstants.TURRET_ANGLE_CALCULATION.GEAR_1_RATIO();
        ...
        double turretAngle = finalEnc1Total / V0_FunkyTurretConstants.TURRET_ANGLE_CALCULATION.GEAR_1_RATIO();
