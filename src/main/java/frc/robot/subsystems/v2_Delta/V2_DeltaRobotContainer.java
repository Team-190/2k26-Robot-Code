...
public class V2_DeltaRobotContainer implements RobotContainer {
    ...
    private void configureAutos() {
        ...
        NamedCommands.registerCommand("SCORE_OR_FEED", V2_DeltaCompositeCommands.scoreOrFeedCommand(shooter, clopper));

        NamedCommands.registerCommand("SCORE_AGITATE", V2_DeltaCompositeCommands.scoreOrFeedCommand(shooter, clopper)
                .alongWith(
                        Commands.sequence(
                                    ...
                                    return (V2_DeltaRobotState.isInAllianceZone()
                                            ...
                                            .minus(
                                                    robotPose
                                                            .transformBy(
                                                                    new Transform2d(
                                                                            V2_DeltaShooterConstants.TURRET_CONSTANTS.robotToTurretTransform
                                                                                    .getX(),
                                                                            V2_DeltaShooterConstants.TURRET_CONSTANTS.robotToTurretTransform
                                                                                    .getY(),
                                                                            Rotation2d.kZero))
