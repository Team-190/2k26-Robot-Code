...
public class V2_DeltaRobotContainer implements RobotContainer {
    ...
    private void configureAutos() {
        ...
        autoChooser.addCmd("Left Full", () -> V2_DeltaAutoLeftFull.getAutoRoutine(drive, intake, clopper, shooter));
        autoChooser.addCmd(
                "Right Bucks", () -> V2_DeltaAutoRightOPBucks.getAutoRoutine(drive, intake, clopper, shooter));
        autoChooser.addCmd(
                "Left Bucks", () -> V2_DeltaAutoLeftOPBucks.getAutoRoutine(drive, intake, clopper, shooter));
