package frc.robot.subsystems.v2_Delta.leds;
...
public class V2_DeltaCANdle extends VirtualSubsystem {
  ...
  private enum Section {
    ...
    public int getEnd() {
      return switch (this) {
        case STATUS -> 7;
        case MAIN, WHOLE -> V2_DeltaCANdleConstants.LED_COUNT;
      };
    }
  ...
  public V2_DeltaCANdle() {
    super();
    leds = new CANdle(V2_DeltaCANdleConstants.CAN_ID, V2_DeltaCANdleConstants.CAN_LOOP);
        ...
        new Trigger(
                () ->
                    RobotController.getBatteryVoltage()
                        < V2_DeltaCANdleConstants.LOW_BATTERY_VOLTAGE)
            .debounce(.5);
    candleAnimation =
  ...
  public synchronized void periodic() {
    ...
    if (loopCycleCount <= V2_DeltaCANdleConstants.MIN_LOOP_CYCLE_COUNT) {
      loopCycleCount++;
      return;
    }
