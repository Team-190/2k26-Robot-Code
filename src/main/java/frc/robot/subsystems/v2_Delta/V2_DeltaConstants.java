...
public class V2_DeltaConstants {
    public static final DriveConfig DRIVE_CONFIG = new DriveConfig(
    ...
    public static final Gains DRIVE_GAINS = Gains.builder()
            .withKP(
    ...
    public static final Gains TURN_GAINS = Gains.builder()
            .withKP(
                    new LoggedTunableNumber(
    ...
    public static final Gains AUTO_ALIGN_Y_GAINS = Gains.builder()
            .withKP(new LoggedTunableNumber("Drive/Auto Align/Y/Kp", 3.0))
            .withKD(new LoggedTunableNumber("Drive/Auto Align/Y/Kd", 0.15))
            .build();

    public static final LinearConstraints AUTO_ALIGN_Y_CONSTRAINTS = LinearConstraints.builder()
            .withMaxVelocity(
                    new LoggedTunableMeasure<>(
    ...
    public static final Gains AUTO_ALIGN_THETA_GAINS = Gains.builder()
    ...
    public static final AngularPositionConstraints AUTO_ALIGN_THETA_CONSTRAINTS = AngularPositionConstraints.builder()
            .withMaxVelocity(
                    new LoggedTunableMeasure<>(
    ...
    public static final SwerveDriveConstants.AutoAlignConstants AUTO_ALIGN_CONSTANTS = SwerveDriveConstants.AutoAlignConstants
            .builder()
    ...
    public static final SwerveDriveConstants DRIVE_CONSTANTS = SwerveDriveConstants.builder()
    ...
    public static final LimelightConfig LIMELIGHT_SHOOTER_CONFIG = LimelightConfig.builder()
            .key("shooter")
    ...
    public static final LimelightConfig LIMELIGHT_CLIMBER_CONFIG = LimelightConfig.builder()
            .key("climber")
            .cameraType(CameraType.LIMELIGHT_4)
            .horizontalFOV(CameraType.LIMELIGHT_4.horizontalFOV)
            .verticalFOV(CameraType.LIMELIGHT_4.verticalFOV)
    ...
    public static final LimelightConfig LIMELIGHT_RIGHT_CONFIG = LimelightConfig.builder()
            .key("right")
            .cameraType(CameraType.LIMELIGHT_4)
            .horizontalFOV(CameraType.LIMELIGHT_4.horizontalFOV)
            .verticalFOV(CameraType.LIMELIGHT_4.verticalFOV)
