...
public class V1_GammaSwankIOTalonFXSim extends V1_GammaSwankIOTalonFX {
    ...
    public void updateInputs(V1_GammaSwankIOInputs inputs) {
        ...
        Angle rotorPosition = Angle.ofBaseUnits(swankSim.getAngularPositionRad() * swankSim.getGearing(), Radians);
        AngularVelocity rotorVelocity = AngularVelocity.ofBaseUnits(swankSim.getAngularVelocityRadPerSec() * swankSim.getGearing(), RadiansPerSecond);
