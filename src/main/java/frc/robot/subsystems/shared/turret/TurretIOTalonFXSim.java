...
public class TurretIOTalonFXSim extends TurretIOTalonFX {
    ...
    public void updateInputs(TurretIOInputs inputs) {
        ...
        Angle rotorPosition = Angle.ofBaseUnits(turretSim.getAngularPositionRad() * turretSim.getGearing(), Radians);
        AngularVelocity rotorVelocity = AngularVelocity.ofBaseUnits(turretSim.getAngularVelocityRadPerSec() * turretSim.getGearing(), RadiansPerSecond);
