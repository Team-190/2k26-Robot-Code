...
public enum LinkageState {
    ...
    public Output set(double leftVolts, double rightVolts) {
        switch (this) {
            ...
            case CLOSED_LOOP_POSITION_CONTROL -> throw new IllegalStateException("Not voltage controlled");
        }
    ...
    public sealed interface Output
            permits Output.Voltage, Output.Position {
        ...
        record Voltage(double leftVolts, double rightVolts)
                implements Output {
        ...
        record Position(Rotation2d left, Rotation2d right)
                implements Output {
