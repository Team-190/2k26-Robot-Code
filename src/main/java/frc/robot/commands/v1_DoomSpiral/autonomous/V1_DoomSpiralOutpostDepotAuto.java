 ...
 */
public class V1_DoomSpiralOutpostDepotAuto {
   ...
   */
  public static final AutoRoutine V1_DoomSpiralOutpostDepot(
      SwerveDrive drive,
    ...
    AutoTrajectory OUTPOST_DEPOT =
        routine.trajectory(V1_DoomSpiralAutoTrajectoryCache.OUTPOST_DEPOT);
