  ...
  public static final BetterAutoChooser.AutoRoutineConfiguration getAutoRoutine(
    ...
    AdjustPathCommand followCommand =
        new AdjustPathCommand(
            () -> RIGHT_TRENCH_SIMPLE_CROSSES.getFinalPose().get(), 0, pathAdjustmentModeSupplier);
            ...
            Commands.sequence(
                ...
                followCommand.onlyWhile(
                    () -> {
                      ...
                      Pose2d targetPose = RIGHT_TRENCH_SIMPLE_CROSSES.getFinalPose().get();
            ...
            Commands.runOnce(
                () -> {
                  ...
                  V1_DoomSpiralRobotState.setAutoTrajectory(
                      RIGHT_TRENCH_SIMPLE_CROSSES, RIGHT_RETURN);
                }));
  }
}
