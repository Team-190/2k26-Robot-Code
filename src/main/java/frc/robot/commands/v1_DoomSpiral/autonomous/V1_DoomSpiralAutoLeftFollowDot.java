...
public class V1_DoomSpiralAutoLeftFollowDot {
  ...
  public static final BetterAutoChooser.AutoRoutineConfiguration getAutoRoutine(
    ...
    AutoRoutine routine = drive.getAutoFactory().newRoutine("LEFT_FOLLOW_DOT");

    AutoTrajectory LEFT_DOT_1 = routine.trajectory(V1_DoomSpiralAutoTrajectoryCache.LEFT_DOT_1);

    PathPlannerPath V1_DOT;
    try {
      V1_DOT = PathPlannerPath.fromPathFile("V1_DOT");
    } catch (Exception e) {
      e.printStackTrace();
    ...
    AdjustPathCommand followCommand =
        new AdjustPathCommand(() -> LEFT_DOT_1.getFinalPose().get(), 0, pathAdjustmentModeSupplier);
            ...
            Commands.sequence(
                ...
                followCommand.onlyWhile(
                    () -> {
                      ...
                      Pose2d targetPose = LEFT_DOT_1.getFinalPose().get();
    ...
    return new BetterAutoChooser.AutoRoutineConfiguration(
        () -> routine,
        () -> LEFT_DOT_1.getInitialPose().orElse(new Pose2d()),
        () ->
            Commands.runOnce(
                () -> {
                  ...
                  V1_DoomSpiralRobotState.setAutoTrajectory(LEFT_DOT_1);
                }));
  }
}
