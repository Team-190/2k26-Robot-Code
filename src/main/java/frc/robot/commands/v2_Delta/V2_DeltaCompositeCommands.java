...
public class V2_DeltaCompositeCommands {
  ...
  public static Command scoreCommand(
    ...
    return Commands.parallel(intake.stopRoller(), shooter.setGoal(ShooterGoal.SCORE));
  }

  public static Command stopShooterCommand(V2_DeltaShooter shooter, V2_DeltaClopper clopper) {
