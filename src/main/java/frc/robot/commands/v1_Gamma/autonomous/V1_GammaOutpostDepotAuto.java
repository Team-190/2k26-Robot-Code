...
/**
 * Autonomous Path for gathering fuel from the outpost, gathering fuel from depot, going to the
...
public class V1_GammaOutpostDepotAuto {
   ...
   * running another autonomous path for going to the depot, gathering fuel, going to the tower,
   * scoring the fuel, then climbing tolevel 1
   *
   ...
   * @return the Command for the entire Outpost + Depot Autonomous Path
   */
  public static final Command V1_GammaOutpostDepot(
      SwerveDrive drive,
    ...
    // Load the trajectory and commands for the first part of the outpost-depot auto
    ...
    // Load the commands for the second part of the outpost-depot auto
    Command OUTPOST_DEPOT_CMD = drive.getAutoFactory().trajectoryCmd("OUTPOST_DEPOT");
