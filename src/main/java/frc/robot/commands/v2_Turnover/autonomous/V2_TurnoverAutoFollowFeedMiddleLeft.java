...
public class V2_TurnoverAutoFollowFeedMiddleLeft {
  public static Command getAutoRoutine(
    ...
    try {
      PathPlannerPath FOLLOW_1 = PathPlannerPath.fromPathFile("FOLLOW_FEED_1");
      PathPlannerPath FOLLOW_2 = PathPlannerPath.fromPathFile("FOLLOW_FEED_MIDDLE_2");
